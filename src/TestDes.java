...
//        d.génèreClé(0);
//        System.out.println(Arrays.toString(d.fonctions_S(new int[]{0,1,0,1,1,1},0)));
//        ///
//
...
//        System.out.println(Arrays.toString(t.crypteTripleDES(s)));
        System.out.println(t.decrypteTripleDES(t.crypteTripleDES(s)));
